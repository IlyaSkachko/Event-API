...
namespace Events.Application.Validation.Participant
{
    public class ParticipantAuthValidator : AbstractValidator<ParticipantAuthDTO>
    {
        ...
        {
            RuleFor(participant => participant.Email).NotEmpty().WithMessage("The email can't be empty")
            ...
            RuleFor(participant => participant.Password).NotEmpty().WithMessage("The password can't be empty")
